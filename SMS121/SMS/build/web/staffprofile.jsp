...
<%
    ...
    rs.next();
        ...
        %>
        <form method="get" action="UpdateProfile1.jsp">
        ...
        <tr><td><%=rsmd.getColumnLabel(7)%></td><td><input type="text" name="t7" value="<%=rs.getString(7)%>" readonly=""></td></tr>        <tr><td colspan="2" align="center"><input type="submit" value="Update"></td></tr>
        </form></center>
        <%
    %>
    </table>
