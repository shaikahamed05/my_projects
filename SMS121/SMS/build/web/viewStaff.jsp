...
</br><center><h2 class="logo">Staff Details</h2></center></br>
        <%
            ResultSet rs=st.executeQuery("Select * from staff");
            ResultSetMetaData rsmd=rs.getMetaData();
            int cc=rsmd.getColumnCount();
            %>
            <center><table width=1000 align="center" border="1" bordercolor="#000000" style="background-color: #B9B4B4;"></center>
                <tr>
                    <%
                        for(int i=1;i<=cc;i++)
                        {
                        ...
                        while(rs.next())
                        {
                            ...
                            <tr>
                                ...
                                for(int i=1;i<=cc;i++)
                                {
                                 ...
                                 %>
                                 <td><a href="updateStaff.jsp?sid=<%=rs.getString(1)%>">Update</a></td>
                                 <td><a href="deleteStaff.jsp?sid=<%=rs.getString(1)%>">Delete</a></td>
                            </tr>
                            <%
                        }
                        %>
