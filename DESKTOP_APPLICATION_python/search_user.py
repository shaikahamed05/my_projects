...
def searchuser(username,usersname):
    def showuser():
    ...
    try:
        ...
        '''
        profile = PhotoImage(file='profile_emoji.png')
        profileButton = Button(mailprofile_window, image=profile, cursor='hand2', bg='white', bd=0)
        profileButton.place(x=700, y=465)

        # search bar navigator

        search = PhotoImage(file='search_emoji.png')
        searchButton = Button(mailprofile_window, image=search, cursor='hand2', bg='white', bd=0,
                                  )
        searchButton.place(x=500, y=465)

        # game navigator

        game = PhotoImage(file='game_emoji.png')
        gameButton = Button(mailprofile_window, image=game, cursor='hand2', bg='white', bd=0,
                                )
        gameButton.place(x=300, y=465)
        ...
        biolabel = Label(mailprofile_window, text='BIO:', font=('Lucida Handwrit', 9, 'bold',), bg='white',
                         fg='black')
        biolabel.place(x=300 + 100, y=90 + 40)

        bioEntry = Label(mailprofile_window, text=bio, width=50, height=5, bd=0, bg='gray90', fg='black')
        bioEntry.place(x=300 + 100, y=115 + 40)

        genderlabel = Label(mailprofile_window, text='GENDER:', font=('Lucida Handwrit', 9, 'bold',),
                            bg='white',
                            fg='black')
        genderlabel.place(x=300 + 100, y=200 + 40)

        genderEntry = Label(mailprofile_window, text=gender, width=10, bd=0, bg='gray90', fg='black')
        genderEntry.place(x=300 + 100, y=225 + 40)
        ...
        DOBlabel = Label(mailprofile_window, text='DATE OF BIRTH:', font=('Lucida Handwrit', 9, 'bold',),
                         bg='white',
                         fg='black')
        DOBlabel.place(x=400 + 100, y=200 + 40)

        DOBEntry = Label(mailprofile_window, text=dob, width=20, bd=0, bg='gray90', fg='black')
        DOBEntry.place(x=400 + 100, y=225 + 40)


        LogoutButton = Button(mailprofile_window, text='Logout', height=2, width=15, bd=0, bg='deep sky blue',
                              fg='white',
                              command=logout)
        LogoutButton.place(x=1240, y=700)

        backButton = Button(mailprofile_window, text='Back', width=10, bd=0, bg='gray', fg='black',
